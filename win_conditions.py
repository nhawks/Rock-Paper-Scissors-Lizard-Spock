...
class WinConditions:
    ...
    def gesture_comparison(self, player_one, player_two):
        if player_one.choice == player_two.choice:
            ...
            if (
                player_two.choice == "scissors"
                or player_two.choice == "lizard"
            ):
                return True
            elif (
                player_two.choice == "paper"
                or player_two.choice == "spock"
            ):
                return False
            ...
            if (
                player_two.choice == "spock"
                or player_two.choice == "paper"
            ):
                return True
            elif (
                player_two.choice == "rock"
                or player_two.choice == "scissors"
            ):
                return False
        elif player_one.choice == "spock":
            if (
                player_two.choice == "scissors"
                or player_two.choice == "rock"
            ):
                return True
            if (
                player_two.choice == "lizard"
                or player_two.choice == "paper"
            ):
                return False
